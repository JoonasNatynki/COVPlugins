#undef PLAYERPAWNCOMPONENTS_API
#undef PLAYERPAWNCOMPONENTS_VTABLE
...
#define PLAYERPAWNCOMPONENTS_VTABLE DLLEXPORT_VTABLE
#define PLAYERPAWNCOMPONENTS_API DLLEXPORT
